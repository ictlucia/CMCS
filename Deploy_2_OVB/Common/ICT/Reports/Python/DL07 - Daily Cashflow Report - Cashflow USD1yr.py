...
ael_gui_parameters = {
    ...
    "windowCaption": "DL07 - Daily Cashflow Report - Cashflow USD1yr",
}
ael_variables = [
    [
        "report_name",
        ...
        "string",
        None,
        "DL07 - Daily Cashflow Report - Cashflow USD1yr",
        1,
        0,
    ],
    [
...
def ael_main(parameter):
    ...
    port_list = [
        "('IRT DCM 1 BMDL', 'IRT DCM 2 BMDL')",
        "('BB BOND OCI BMDL', 'BB BOND SHARIA OCI BMDL', 'IBFI 1 BMDL', 'CB 1 BMDL', 'CB 2 BMDL', 'CB 3 BMDL', 'CB 4 BMDL', 'CB 5 BMDL', 'CB 6 BMDL', 'GVI 1 BMDL', 'GVI 2 BMDL', 'Commercial 1 BMDL', 'Commercial 2 BMDL', 'Commercial 3 BMDL', 'Commercial 4 BMDL', 'Commercial 5 BMDL', 'Commercial 6 BMDL', 'SAM 1 BMDL', 'SAM 2 BMDL', 'SAM 3 BMDL')",
        "('BB BOND AC BMDL','BB BOND SHARIA AC BMDL')",
    ]
    ...
    sub_row_b = {
        ...
        "Pelunasan Pinjaman Nasabah (Pokok &#38; Bunga)&emsp;*4)": [
            "",
            "",
            "",
            "",
        ...
        "Pembelian USD": ["('fx')", optkey4_list[2], "", "", "", ""],
    ...
    sub_row_c = {
        ...
        "AFS": ["('BOND','SBI')", optkey4_list[1], port_list[1], "", "", "FVOCI"],
        "HTM": ["('BOND','SBI')", optkey4_list[1], port_list[2], "", "", "FVTPL"],
        "Penarikan Pinjaman Nasabah&emsp;*1)": ["", "", "", "", "", ""],
        "Saldo Vostro": ["", "", "", "", "", ""],
        "Lainnya&emsp;*7)": ["", "", "", "", "", ""],
        "ADDITIONAL VARIABLES FOR NON BANK INSTITUTION": ["", "", "", "", "", ""],
        "Penempatan Deposito / DOC": ["", "", "", "", "", ""],
        "Penjualan Obligasi (proprietary trading)": ["", "", "", "", "", ""],
        "Penjualan USD": ["('fx')", optkey4_list[2], "", "", "", ""],
        "Funding Bonds & IPO": ["", "", "", "", "", ""],
        "Biaya Operational": ["", "", "", "", "", ""],
    }
    # List for the values
