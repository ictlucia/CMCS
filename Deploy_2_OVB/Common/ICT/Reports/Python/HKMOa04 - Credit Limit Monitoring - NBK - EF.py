...
ael_gui_parameters={'runButtonLabel':'&&Run',
                    ...
                    'windowCaption':'HKMOa04 - Credit Limit Monitoring - NBK - EF'}
ael_variables=[
['report_name','Report Name','string', None, 'HKMOa04 - Credit Limit Monitoring - NBK - EF', 1,0],
...
def ael_main(parameter):
    ...
    title = "HKMOa04 - Credit Limit Monitoring - NBK - EF"
