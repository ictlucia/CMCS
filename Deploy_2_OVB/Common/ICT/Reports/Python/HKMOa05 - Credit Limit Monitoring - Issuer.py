...
ael_gui_parameters={'runButtonLabel':'&&Run',
                    ...
                    'windowCaption':'HKMOa05 - Credit Limit Monitoring - Issuer'}
ael_variables=[
['report_name','Report Name','string', None, 'HKMOa05 - Credit Limit Monitoring - Issuer', 1,0],
['file_path', 'Folder Path', getFilePathSelection(), None, getFilePathSelection(), 1, 1],
['output_file','Output Files','string', ['.pdf', '.xls'], '.pdf', 1, 0, 'Select Output Extension Type'],
['compliance_rule','Compliance Rule','string', get_compliance_rule_name('Pre-Deal', 'PositionAndRiskControl'), 'BMHK Issuer Limit', 1,0, 'Compliance Rule with Pre-Deal Category and Position Risk Control Type']
]
...
def ael_main(parameter):
    ...
    title = "HKMOa05 - Credit Limit Monitoring - Issuer"
    header_list = ["Id", "FullName", "Ccy", "LimitAmt", "ExpDate", "ProductType", "LimAmt", "Exposure"]
