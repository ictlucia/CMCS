...
def getDataQuery():
    queryAcc = acm.FSQL["SGBO18 - Nostro Movement - Account"].Value().Text()
    querySett = acm.FSQL["SGBO18 - Nostro Movement - settlement"].Value().Text()
...
ael_gui_parameters={'runButtonLabel':'&&Run',
                    ...
                    'windowCaption':'SGBO18 - Nostro Movement - EOD'}
ael_variables=[
['report_name','Report Name','string', None, 'SGBO18 - Nostro Movement - EOD', 1,0],
