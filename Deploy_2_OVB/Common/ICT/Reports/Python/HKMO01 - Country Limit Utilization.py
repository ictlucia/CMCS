...
ael_gui_parameters={'runButtonLabel':'&&Run',
                    ...
                    'windowCaption':'HKMO01 - Country Limit Utilization'}
ael_variables=[
['report_name','Report Name','string', None, 'HKMO01 - Country Limit Utilization', 1,0],
...
def ael_main(parameter):
    ...
    title = "HKMO01 - Country Limit Utilization"
    header_list = ["CountryId", "LongName", "Ccy", "LimitAmt", "ExpDate", "ProductType", "LimAmt", "Exposure"]
    content_align = ["mid", "left", "mid", "mid", "mid", "mid", "right", "right"]
