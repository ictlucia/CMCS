...
/****** Object:  StoredProcedure [dbo].[InsertUpdateAppliedRuleData]    Script Date: 28-Nov-23 2:31:08 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[InsertUpdateAppliedRuleData] 
													@UniqueID                    bigint, 
...
BEGIN
	...
	BEGIN
	INSERT INTO LIMIT_UTILIZATION  VALUES(	@UniqueID, @ComplianceRuleName,@CCY,@CIF, @LimitType, @CounterpartyName,@NotionalLimitThresholdValue,NULL,NULL,@CEMLimitThresholdValue,
								NULL,NULL, @AgreementNumber, @AgreementDate, @RenewalNumber, @RenewalDate, @ApplicationNumber, @LimitEffectiveDate, @LimitExpiryDate, @Status, @UpdateDate);
	END
	ELSE
	BEGIN
	...
	UPDATE LIMIT_UTILIZATION  SET	ComplianceRuleName=@ComplianceRuleName, CCY=@CCY, CIF=@CIF,LimitType = @LimitType, CounterpartyName=@CounterpartyName,
								NotionalLimitThresholdValue=@NotionalLimitThresholdValue,  CEMLimitThresholdValue=@CEMLimitThresholdValue, AgreementNumber=@AgreementNumber, AgreementDate=@AgreementDate, 
