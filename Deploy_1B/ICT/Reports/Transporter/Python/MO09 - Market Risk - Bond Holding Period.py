...
ael_gui_parameters={'runButtonLabel':'&&Run',
                    ...
                    'windowCaption':'Market Risk - Bond Holding Period'}



ael_variables=[

['report_name','Report Name','string', None, 'MO09 - Market Risk - Bond Holding Period', 1,0],
...
def ael_main(parameter):
    ...
    html_content = html_gen.create_base_html_content("Market Risk - Bond Holding Period. "+today,title_style)
    xsl_fo_content = xsl_gen.prepare_xsl_fo_content("Market Risk - Bond Holding Period "+today)
    ...
    buying_qf = acm.FStoredASQLQuery['BHP_BuyQuery']
    selling_qf = acm.FStoredASQLQuery['BHP_SellQuery']
    buy_result = []
    sell_result = []
