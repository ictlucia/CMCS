...
def get_val_query():
    query = acm.FSQL['test_query bo70'].Text()
    pedagangList, perantaraList = ael.asql(query)[1]
    
    pedagangDict = {}
    for pedagangVal in pedagangList:
        pedagangDict[pedagangVal[1]] = {}
        pedagangDict[pedagangVal[1]][pedagangVal[2]] = pedagangVal[3:]
    
    perantaraDict = {}
    for perantaraVal in perantaraList:
        perantaraDict[perantaraVal[1]] = {}
        perantaraDict[perantaraVal[1]][perantaraVal[2]] = perantaraVal[3:]
...
def generate_excel(report_folder, report_name):
    pedagang_ebus, perantara_ebus = get_val_query()
...
ael_gui_parameters={'runButtonLabel':'&&Run',
                    ...
                    'windowCaption':'BO70 - PPE EBUS Sebagai Pedagang (BO)'}
                    
ael_variables=[
['report_name','Report Name','string', None, 'BO70 - PPE EBUS Sebagai Pedagang (BO)', 1,0],
